...
public class AesUtil {
	...
	private static final String KEYS = "#1234567890rdpe@*";
	...
	public static String decrypt(String content) {
		try {
			...
			byte[] byteContent = Base64.decode(content.toCharArray());
	...
	public static void main(String[] args) {
		...
		String url = "jdbc:mysql://172.16.11.56:3306/rdpeNew?zeroDateTimeBehavior=convertToNull&autoReconnect=true&amp;useUnicode=true&amp;characterEncoding=UTF8";
		String user = "root";
		String password = "root123";
		System.out.println(encrypt(url));
		System.out.println(encrypt(user));
		System.out.println(encrypt(password));
		System.out.println(encrypt(driverName));
	}
